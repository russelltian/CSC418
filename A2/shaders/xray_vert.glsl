...
void main() {
  ...
  gl_Position = projection * vertPos4;
    ...
    //my solution
    vertPos = vec3(vertPos4/vertPos4.w); // make sure vertPos4.w after modelview is 1.0
    normalInterp = vec3(normalMat*vec4(normal,1.0)); // find the normal in camera space
    viewVec = -vertPos; // find viewVec
}
