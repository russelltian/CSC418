...
function Renderer(canvasName, vertSrc, fragSrc)
{
  ...
  var worldPositionLoc = -1;

  // public
  this.updateShader = function (newvertSrc, newfragSrc, blend) {
    vertSrc = newvertSrc;
    fragSrc = newfragSrc;
	useBlending = blend;
  ...
  function setupShaders() {
	...
	if (worldPositionLoc >= 0)
		gl.disableVertexAttribArray(worldPositionLoc);
